package com.yue.flutter.example.qrcode_descriptor;
...
/** QrcodeDescriptorPlugin */
public class QrcodeDescriptorPlugin implements FlutterPlugin, MethodCallHandler {
...
//        HINTS.put(DecodeHintType.PURE_BARCODE, Boolean.TRUE);
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "qrcode_descriptor");
